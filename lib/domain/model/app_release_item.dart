...
class AppReleaseItem implements PlayableItem {
  ...
  OwnerType ownerType; ///TO KNOW IF RELEASE WAS UPLOADED FROM USER OR COLLECTIVE TO FLOW
  ...
  String? lyrics; ///LYRICS FOR SONGS (plain text from artist)
  String? lyricsLrc; ///SYNCED LRC LYRICS (generated by Whisper AI alignment)

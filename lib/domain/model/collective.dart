...
class Collective {
  ...
  /// Kanban board ID for collective task management (workspace feature)
  String boardId;
  ...
  Map<String, CollectiveMember>? members;

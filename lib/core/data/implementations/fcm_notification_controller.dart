...
//   /// *********************************************
//
//   static final FCMNotificationController _instance =
//   FCMNotificationController._internal();
//
//   factory FCMNotificationController() {
//     return _instance;
//   }
//
//   FCMNotificationController._internal();
...
//         onFcmSilentDataHandle: FCMNotificationController.mySilentDataHandle,
//         onFcmTokenHandle: FCMNotificationController.myFcmTokenHandle,
//         onNativeTokenHandle: FCMNotificationController.myNativeTokenHandle,
//         licenseKeys:
//         // On this example app, the app ID / Bundle Id are different
//         // for each platform, so i used the main Bundle ID + 1 variation
//         [
//           AppFlavour.getFcmKey()
//         ],
//         debug: debug);
//   }
//
...
//     AppUtilities.showSnackBar("Silent data received","");
//
...
//     AppUtilities.showSnackBar('Fcm token received',"");
...
//     AppUtilities.showSnackBar('Native token received',"");

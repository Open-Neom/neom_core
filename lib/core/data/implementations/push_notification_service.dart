...
class PushNotificationService {
  ...
  static Future<void> init() async {
    ...
    try {
      if(notificationSettings.authorizationStatus == AuthorizationStatus.authorized) {
        AppUtilities.logger.i('✅ Notification permission granted');
        ...
        AppUtilities.logger.w('❌ Notification permission denied');
      }
  ...
  static List<NotificationChannelGroup> getChannelGroups() {
    return [
